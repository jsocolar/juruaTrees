...
plot(density(colSums(100*agb_tf[[1]]$stemwise_AGB_diff)/colSums(agb_tf[[1]]$agb_1)), 
...
for(i in 2:length(agb_tf)){
  lines(density(colSums(100*agb_tf[[i]]$stemwise_AGB_diff)/colSums(agb_tf[[i]]$agb_1)))
}

# Plot results in Varzea
plot(density(colSums(100*agb_vz[[1]]$stemwise_AGB_diff)/colSums(agb_vz[[1]]$agb_1)), 
     xlim =c(-60,35), ylim = c(0,3), ylab = "probability density", yaxt = "n", 
     xlab = "AGB difference (percent)", main = "Varzea")
for(i in 2:length(agb_vz)){
  lines(density(colSums(100*agb_vz[[i]]$stemwise_AGB_diff)/colSums(agb_vz[[i]]$agb_1)))
}
...
for(i in c(2:31, 33:length(agb_vz))){
  lines(density(colSums(100*agb_vz[[i]]$stemwise_AGB_diff)/colSums(agb_vz[[i]]$agb_1)), col = "gray")
}
lines(density(colSums(100*agb_vz[[1]]$stemwise_AGB_diff)/colSums(agb_vz[[1]]$agb_1)), col = "firebrick2", lwd = 2)
lines(density(colSums(100*agb_vz[[2]]$stemwise_AGB_diff)/colSums(agb_vz[[2]]$agb_1)), col = "blue", lwd = 2)
lines(density(colSums(100*agb_vz[[20]]$stemwise_AGB_diff)/colSums(agb_vz[[20]]$agb_1)), col = "orange", lwd = 2)
lines(density(colSums(100*agb_vz[[30]]$stemwise_AGB_diff)/colSums(agb_vz[[30]]$agb_1)), col = "purple", lwd = 2)
lines(density(colSums(100*agb_vz[[33]]$stemwise_AGB_diff)/colSums(agb_vz[[33]]$agb_1)), col = "forestgreen", lwd = 2)
...
for(i in c(2:31, 33:length(agb_tf))){
  lines(density(colSums(100*agb_tf[[i]]$stemwise_AGB_diff)/colSums(agb_tf[[i]]$agb_1)), col = "gray")
}
lines(density(colSums(100*agb_tf[[1]]$stemwise_AGB_diff)/colSums(agb_tf[[1]]$agb_1)), col = "firebrick2", lwd = 2)
lines(density(colSums(100*agb_tf[[2]]$stemwise_AGB_diff)/colSums(agb_tf[[2]]$agb_1)), col = "blue", lwd = 2)
lines(density(colSums(100*agb_tf[[20]]$stemwise_AGB_diff)/colSums(agb_tf[[20]]$agb_1)), col = "orange", lwd = 2)
lines(density(colSums(100*agb_tf[[30]]$stemwise_AGB_diff)/colSums(agb_tf[[30]]$agb_1)), col = "purple", lwd = 2)
lines(density(colSums(100*agb_tf[[33]]$stemwise_AGB_diff)/colSums(agb_tf[[33]]$agb_1)), col = "forestgreen", lwd = 2)
